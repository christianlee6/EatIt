...
def seed_recipes():
    recipe1 = Recipe(
        ...
        difficulty = 3,
        prep_time = 120,
        preview_img = "https://www.onceuponachef.com/images/2019/09/Spaghetti-and-Meatballs.jpg",
